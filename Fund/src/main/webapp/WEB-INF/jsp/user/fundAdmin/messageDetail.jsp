				...
				<div class="panel panel-default col-md-8 col-md-offset-2 ">
					<div class="panel-body ">
						<div class="row form-group">
							...
							<div class="col-md-8">
								<label class="form-control">${msg.msgTitle }</label>
							</div>
						</div>
						<div class="row form-group">
							<label class="col-md-2 control-label">时间</label>
							<div class="col-md-8">
								<label class="form-control"><fmt:formatDate value="${msg.receivedTime }" pattern="yyyy-MM-dd HH:mm:ss"/></label>
							</div>
						</div>
						<div class="form-group row">
							<label class="col-md-2 control-label">内容</label>
							<div class="col-md-8">
								<div class="test_box form-control" contenteditable="false" >${msg.msgContent}</div>
							</div>
						</div>
						<div class="form-group row">
						...
						<div>
							<div class="text-center" style="text-align: center">
								<button class="btn btn-danger" onclick="deleteOneMessage(${msg.messageId},true)">
