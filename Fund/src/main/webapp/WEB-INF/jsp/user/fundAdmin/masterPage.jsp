							...
							<nav id="menu" class="nav-main" role="navigation">
								<ul class="nav nav-sidebar">
									<div class="panel-body text-center">								
										<div class="bk-avatar">
											<img src="/Fund/assets/png/fundAdmin.png" class="img-circle bk-img-60" alt="" />
										</div>
									...
									<li >
										<a href="${pageContext.request.contextPath}/fundAdmin/toFundMana.action">
											<i class="fa fa-user" aria-hidden="true"></i><span>财务管理</span>
											<!-- <i class="fa fa-copy" aria-hidden="true"></i><span>账号管理</span> -->
										</a>
									</li>
									<li>
									...
									<li>
										<a href="${pageContext.request.contextPath}/fundAdmin/changePwd.action">
