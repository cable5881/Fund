...
<link rel="stylesheet" href="${pageContext.request.contextPath}/static/zebra_datepicker/css/metallic.css" type="text/css">
</head>
<body>
		...
		<form id="projectApp" class="form-horizontal ">
						...
						<div class="form-group">
							...
							<div class="col-md-9">
								<input type="text" id="text8" name="benificiaryunitId"
									value="${p.benificiaryUnit.bunitName}"
						...
						<div class="form-group">
							...
							<div class="col-md-9">
								<input type="text" id="text35" name="donor.dEmail"
									value="${p.donor.dEmail}" class="form-control text-perEm-land">
								<span class="help-block span-perEm-info" style="color: red"></span>
							</div>
						</div>
					</div>
				</div>
			...
			<div>
				<div class="col-md-3 col-md-offset-3" style="text-align: center">
					<button id="saveBtn" type="button" class="btn btn-info"
	...
	<script type="text/javascript"
		src="${pageContext.request.contextPath}/assets/js/pages/dateFormatter.js"></script>
	<script type="text/javascript"
		src="${pageContext.request.contextPath}/assets/js/pages/modifyProjectForm.js"></script>
	<script type="text/javascript"
		src="${pageContext.request.contextPath}/assets/js/pages/submitModifyProForm.js"></script>
	<script type="text/javascript">
		function executeAction(mode) {
			if (check()) {
				...
				$.ajax({
							type : "POST",
							url : "${pageContext.request.contextPath}/benificiary/updateProject.action",
							data : params,
							dataType : "json",
							success : function(data) {
								if (data.resultCode == 1) {
									window.location = "${pageContext.request.contextPath}/benificiary/index.action";
