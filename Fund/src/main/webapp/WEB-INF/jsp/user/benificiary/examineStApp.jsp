		...
		<div class="row">
						...
						<div class="panel-body">
							...
							<div class="row">
								...
								<div class="form-group col-md-6">
									...
									<div class="col-md-8">
										<label class="form-control">${app.stIndivInfo.stSex}</label>
									</div>
								</div>
							</div>
							<div class="row">
			...
			<div>
				<div class="col-md-3 col-md-offset-3" style="text-align: center">
					<button type="button" class="btn btn-danger" onclick="examineStApp(2,${app.stipendappId })">
						<i class="fa fa-times"></i> 审核失败
					</button>
					
				</div>
				<div class="col-md-3 " style="text-align: center">
					<button type="button" class="btn btn-success" onclick="examineStApp(1,${app.stipendappId })">
...
<script type="text/javascript">
	function examineStApp(mode,appId){
		var flag = false;
		if(mode==1)
		{
