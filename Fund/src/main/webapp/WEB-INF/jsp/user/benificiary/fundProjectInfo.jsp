						...
						<table
							...
							<tbody>
								...
								<tr>
									<td>立项申请表</td>
									<td><a
										href="${pageContext.request.contextPath}/benificiary/checkProjectForm.action?projectId=${p.projectId}"><button
												class="btn btn-info fa fa-eye">查看</button></a></td>
								</tr>
								<tr>
									<td>捐赠协议</td>
									<td><a
										href="<c:url value='/file/downloadProtocol.action'/>"
										target="_blank"><button
												class="btn btn-primary fa fa-download">下载</button></a></td>
								</tr>
								<tr>
									<td>相关新闻链接</td>
									<td><a
										href="${pageContext.request.contextPath}/benificiary/newsLink.action">
