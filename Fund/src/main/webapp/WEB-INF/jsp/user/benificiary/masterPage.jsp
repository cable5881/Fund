							...
							<nav id="menu" class="nav-main" role="navigation">
								<ul class="nav nav-sidebar">
									<div class="panel-body text-center">								
										<div class="bk-avatar">
											<img src="/Fund/assets/png/beneficiary.png" class="img-circle bk-img-60" alt="" />
										</div>
									...
									<li class="nav-parent">
										<a>
											<i class="fa fa-folder" aria-hidden="true"></i><span>立项管理</span>							
										</a>
										<ul class="nav nav-children">
											<li><a href="<c:url value='/benificiary/getProjects.action'/>"><span class="text">所有立项</span></a></li>
											<li><a href="<c:url value='/benificiary/beforeSetUp.action'/>"><span class="text">创建立项</span></a></li>
																						
										</ul>
									</li>
									
									<li>
										<a href="<c:url value='/benificiary/bonusProjects.action'/>">
											<i class="fa fa-eraser" aria-hidden="true"></i><span>审核操作</span>
										</a>
									</li>
									<li>
									...
									<li>
										<a href="<c:url value='/benificiary/changePwd.action'/>">
