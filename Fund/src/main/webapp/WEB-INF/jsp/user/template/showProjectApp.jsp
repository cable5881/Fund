		...
		<div class="panel">
			...
			<div class="panel-body">
				<div class="form-horizontal">
					...
					<div class="form-group">
						<label class="col-md-4 control-label" for="text2">项目引荐人</label>
						<div class="col-md-6">
						...
						<div class="col-md-6">
							<c:choose>
								<c:when test="${p.donationMode.form eq 1 }">
									<div class="radio-custom radio-inline">
										<input type="radio" id="inline-radio3" checked="checked"
											disabled="disabled"> <label for="inline-radio3">现金</label>
									</div>
								</c:when>
								<c:when test="${p.donationMode.form eq 2 }">
									<div class="radio-custom radio-inline">
										<input type="radio" id="inline-radio4" checked="checked"
											disabled="disabled"> <label for="inline-radio4">支票</label>
									</div>
								</c:when>
								<c:when test="${p.donationMode.form eq 3 }">
									<div class="radio-custom radio-inline">
										<input type="radio" id="inline-radio5" checked="checked"
											disabled="disabled"> <label for="inline-radio5">汇票</label>
									</div>
								</c:when>
							</c:choose>
						</div>
					...
					<div class="form-group">
						...
						<div class="col-md-6">
							<label class="form-control">${p.benificiaryUnit.bunitName}</label>
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-md-6">
							<c:choose>
								<c:when test="${p.publicationState eq 1 }">
									<div class="radio-custom radio-inline">
										<input type="radio" id="inline-radio1" checked="checked"
											disabled="disabled"> <label for="inline-radio1">可以公开姓名和捐赠额</label>
									</div>
								</c:when>
								<c:when test="${p.publicationState eq 2 }">
									<div class="radio-custom radio-inline">
										<input type="radio" id="inline-radio1" checked="checked"
											disabled="disabled"> <label for="inline-radio1">只公开姓名</label>
									</div>
								</c:when>
								<c:when test="${p.publicationState eq 3 }">
									<div class="radio-custom radio-inline">
										<input type="radio" id="inline-radio1" checked="checked"
											disabled="disabled"> <label for="inline-radio1">只公开金额</label>
									</div>
								</c:when>
								<c:otherwise>
									<div class="radio-custom radio-inline">
										<input type="radio" id="inline-radio1" checked="checked"
											disabled="disabled"> <label for="inline-radio1">不公开任何信息</label>
									</div>
								</c:otherwise>
							</c:choose>
						</div>
