							...
							<nav id="menu" class="nav-main" role="navigation">
								<ul class="nav nav-sidebar">
									<div class="panel-body text-center">								
										<div class="bk-avatar">
											<img src="/Fund/assets/png/proExpand.png" class="img-circle bk-img-60" alt="" />
										</div>
									...
									<li >
										<a href="${pageContext.request.contextPath}/proExpand/allProjects.action">
											<i class="fa fa-eraser" aria-hidden="true"></i><span>审核立项</span>
										</a>
									...
									<li>
										<a href="${pageContext.request.contextPath}/proExpand/changePwd.action">
