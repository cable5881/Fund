		...
		<div class="panel bk-bg-white bk-margin-bottom-20" id="div1">
			...
			<div class="panel-body">
						...
						<table
							...
							<c:forEach items="${bonusAppList }" var="app" varStatus="status">
									...
									<tr>
										...
										<td><a
												href="<c:url value='/sysAdmin/checkBonusAppForm?appId=${app.scholarshipappId}'/>">
									...
									<tr>
										...
										<td>
											<a href="<c:url value='/sysAdmin/checkBonusAppForm?appId=${app.stipendappId}'/>">
												<button class="btn btn-info fa fa-eye">查看</button>
											</a>
										</td>
									</tr>
				...
				<div class="row myPage">
					<imaw:page url="${pageContext.request.contextPath }/sysAdmin/allBonusAppForms.action"/>
				</div>
			</div>
		</div>
	</div>
