				...
				<div class="panel panel-default col-md-8 col-md-offset-2 ">
					<div class="panel-body ">
						...
						<div class="row form-group">
							...
							<div class="col-md-8">
								<label class="form-control"><fmt:formatDate value="${msg.receivedTime }" pattern="yyyy-MM-dd"/></label>
							</div>
						</div>
						...
						<div>
							<div class="text-center" style="text-align: center">
								<a href="${pageContext.request.contextPath }/message/deleteOneMessage?index=${index}" class="btn btn-danger">
