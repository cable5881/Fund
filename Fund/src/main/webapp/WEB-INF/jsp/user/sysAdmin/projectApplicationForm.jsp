	...
	<div class="main ">
								...
								<div class="col-md-6">
									<c:choose>
										...
										<c:when test="${p.donationMode.realEstate eq 2 }">
											<div class="radio-custom radio-inline">
												<input type="radio" id="inline-radio2" checked="checked" disabled="disabled"> 
		...
		<div>
			<div class="col-md-2 col-md-offset-5" style="text-align: center">
				<a href="${pageContext.request.contextPath}/sysAdmin/editProjectApplicationForm.action"><button type="button" class="btn btn-warning">
