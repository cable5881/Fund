							...
							<nav id="menu" class="nav-main" role="navigation">
								<ul class="nav nav-sidebar">
									<div class="panel-body text-center">								
										<div class="bk-avatar">
											<img src="/Fund/assets/png/proAdmin.png" class="img-circle bk-img-60" alt="" />
										</div>
									...
									<li class="nav-parent">
										...
										<ul class="nav nav-children">
											<li><a href="<c:url value='/proAdmin/toExamineProtocol.action?verified=0'/>"><span class="text">捐赠协议审核</span></a></li>
											<li><a href="<c:url value='/proAdmin/allProjectsUrl.action?verified=0'/>"><span class="text">新闻链接审核</span></a></li>
										</ul>
									</li>
									<li>
									...
									<li>
										<a href="${pageContext.request.contextPath}/proAdmin/changePwd.action">
