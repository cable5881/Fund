							...
							<nav id="menu" class="nav-main" role="navigation">
								<ul class="nav nav-sidebar">
									<div class="panel-body text-center">								
										<div class="bk-avatar">
											<img src="/Fund/assets/png/foundation.png" class="img-circle bk-img-60" alt="" />
										</div>
										<div class="bk-padding-top-10">
											<i class="fa fa-circle text-success"></i> <small>基金会</small>
										</div>
									</div>
									<div class="divider2"></div>
									
									<li >
										<a href="${pageContext.request.contextPath}/foundation/allProjects.action">
											<i class="fa fa-user" aria-hidden="true"></i><span>查看立项</span>
										</a>
									</li>
									<li>
									...
									<li>
										<a href="${pageContext.request.contextPath}/foundation/changePwd.action">
