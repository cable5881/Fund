					...
					<div class="panel-body">
						...
						<div class="row">
							<div class="form-group col-md-6">
								...
								<div class="col-md-8">
									<label class="form-control">${scholarshipQuery.scindivinfo.institute }</label>
								</div>
							</div>
							<div class="form-group col-md-6">
								<label class="col-md-4 control-label" for="text2">学历</label>
								<div class="col-md-8">
									<label class="form-control">${scholarshipQuery.scindivinfo.degrees }</label>
								</div>
							</div>
						</div>
						<div class="row">
							<div class="form-group  col-md-6">
								...
								<div class="col-md-8">
									<label class="form-control">${scholarshipQuery.scindivinfo.major }</label>
								</div>
							</div>
							<div class="form-group col-md-6">
								<label class="col-md-4 control-label" for="text4">班级</label>
								<div class="col-md-8">
									<label class="form-control">${scholarshipQuery.scindivinfo.classes }</label>
								</div>
							</div>
						</div>
						<div class="row">
							<div class="form-group col-md-6">
								...
								<div class="col-md-8">
									<label class="form-control">${scholarshipQuery.scindivinfo.scName }</label>
								</div>
							</div>
							<div class="form-group col-md-6">
								...
								<div class="col-md-8">
									<c:choose>
										<c:when test="${scholarshipQuery.scindivinfo.scSex eq 0 }">
											<label class="form-control">男</label>
										</c:when>
										<c:when test="${scholarshipQuery.scindivinfo.scSex eq 1 }">
						...
						<div class="row">
							<div class="form-group col-md-6">
								...
								<div class="col-md-8">
									<label class="form-control"><fmt:formatDate
											value="${scholarshipQuery.scindivinfo.scBirthday }"
							...
							<div class="form-group col-md-6">
								...
								<div class="col-md-8">
									<label class="form-control">${scholarshipQuery.scindivinfo.scStuid }</label>
								</div>
							</div>
							<div class="row">
								<div class="form-group col-md-6">
									...
									<div class="col-md-8">
										<label class="form-control">${scholarshipQuery.scindivinfo.nation }</label>
									</div>
								</div>
								<div class="form-group col-md-6">
									...
									<div class="col-md-8">
										<label class="form-control"><fmt:formatDate
												value="${scholarshipQuery.scindivinfo.enrolledTime }"
												pattern="yyyy-MM-dd" /></label>
									</div>
								</div>
							</div>
							<div class="row">
								<div class="form-group col-md-6">
									...
									<div class="col-md-8">
										<label class="form-control">${scholarshipQuery.scindivinfo.politicalStatus }</label>
									</div>
								</div>
								<div class="form-group col-md-6">
									<label class="col-md-4 control-label" for="text11">智育成绩（均分）</label>
									<div class="col-md-8">
										<label class="form-control">${scholarshipQuery.scindivinfo.acaScore }</label>
									</div>
								</div>
							</div>
							<div class="row">
								<div class="form-group col-md-6">
									...
									<div class="col-md-8">
										<label class="form-control">${scholarshipQuery.scindivinfo.alltestLevel }</label>
									</div>
								</div>
								<div class="form-group col-md-6">
									<label class="col-md-4 control-label" for="text13">联系电话</label>
									<div class="col-md-8">
										<label class="form-control">${scholarshipQuery.scindivinfo.phoneNumber }</label>
									</div>
								</div>
							</div>
							<div class="row">
								<div class="form-group col-md-6">
									...
									<div class="col-md-8">
										<label class="form-control">${scholarshipQuery.scindivinfo.scEmail }</label>
									</div>
								</div>
							</div>
							<div class="row">
								<div class="form-group ">
									...
									<div class="col-md-8">
										<label class="form-control">${scholarshipQuery.scindivinfo.scAddress }</label>
									</div>
								</div>
							</div>
						</div>
						...
						<div class="form-group">
							<div>
								<textarea id="textarea1" name="textarea1" rows="10"
									...
									style="cursor: text; background-color: white;">${scholarshipQuery.scappinfo.description }</textarea>
							</div>
						</div>
					</div>
				</div>
						...
						<div class="form-group">
							<div>
								<textarea id="textarea2" name="textarea2" rows="10"
									class="form-control" readonly="readonly"
									style="cursor: text; background-color: white;">${scholarshipQuery.scappinfo.scCase }</textarea>
							</div>
						</div>
					</div>
				</div>
						...
						<div class="form-group">
							<div>
								<textarea id="textarea3" name="textarea3" rows="10"
									class="form-control" readonly="readonly"
									style="cursor: text; background-color: white;">${scholarshipQuery.scappinfo.viewClass }</textarea>
							</div>
						</div>
					</div>
				</div>
						...
						<div class="form-group">
							<div>
								<textarea id="textarea4" name="textarea4" rows="10"
									class="form-control" readonly="readonly"
									style="cursor: text; background-color: white;">${scholarshipQuery.scappinfo.viewInstitute }</textarea>
							</div>
						</div>
					</div>
				</div>
						...
						<div class="form-group">
							<div>
								<textarea id="textarea5" name="textarea5" rows="10"
									class="form-control" readonly="readonly"
									style="cursor: text; background-color: white;">${scholarshipQuery.scappinfo.viewJudge }</textarea>
							</div>
						</div>
					</div>
				</div>
