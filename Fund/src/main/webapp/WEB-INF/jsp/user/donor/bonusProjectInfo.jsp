						...
						<div class="table-responsive ">
							<table class="table table-striped table-bordered bootstrap-datatable datatable text-center ">
								<tbody>
									...
									<tr>
										<td>立项申请表</td>
										<td><a href="${pageContext.request.contextPath}/donor/projectApplicationForm.action?projectId=${p.projectId}"><button
						...
						<div class="table-responsive ">
							<table class="table table-striped table-bordered bootstrap-datatable datatable text-center ">
								<tbody>
									...
									<tr>
										<td>报名表</td>
										<td><a href="${pageContext.request.contextPath}/donor/allBonusAppForms.action">
									...
									<tr>
										<td>相关新闻链接</td>
										<td><a
											href="${pageContext.request.contextPath}/donor/newsLink.action">
												<button class="btn btn-info fa fa-eye">查看</button></a>
										</td>
									</tr>
									<tr>
						...
						<div class="table-responsive ">
							<table class="table table-striped table-bordered bootstrap-datatable datatable text-center ">
								<tbody>
									...
									<tr>
										<td>资金到款详情</td>
										<td><a class="btn btn-info fa fa-eye" href="${pageContext.request.contextPath }/donor/checkInBill.action?mCheckId=${p.moneyCheck.moneycheckId}"> 查看</a></td>
									</tr>
									<tr>
										<td>资金发放详情</td>
										<td><a class="btn btn-info fa fa-eye" href="${pageContext.request.contextPath }/donor/checkOutBill.action?mCheckId=${p.moneyCheck.moneycheckId}"> 查看</a></td>
									</tr>
								</tbody>
							</table>
						</div>
