...
function div3Check() {
	...
	if ($.trim($(".text-donName-land").val()) == "") {
	 ...
	 if ((num = boxcheck("donor.dSex")) > 0) { t = 1; } else { t = 0; return; }
...
function formCheck() {
	...
	} else if ($("#div2").css("display") == "inline") {
		$("#lastBtn").css("display", "inline");
		$("#nextBtn").css("display", "inline");
		$("#saveBtn").css("display", "none");
		$("#submitBtn").css("display", "none");
	} else if ($("#div3").css("display") == "inline") {
		$("#lastBtn").css("display", "inline");
		$("#nextBtn").css("display", "inline");
		$("#saveBtn").css("display", "none");
		$("#submitBtn").css("display", "none");
	} else if ($("#div4").css("display") == "inline") {
		$("#lastBtn").css("display", "inline");
		$("#nextBtn").css("display", "inline");
		$("#saveBtn").css("display", "none");
		$("#submitBtn").css("display", "none");
	} else if ($("#div5").css("display") == "inline") {
		$("#lastBtn").css("display", "inline");
...
function nextCheck() {
	if ($("#div1").css("display") == "inline") {
			...
			if (t == 0) {
				...
				$("#proProgress").css("width","100%");
				$("#proProgress").html("100%");
				formCheck();
				return true;
			}
	} else if ($("#div4").css("display") == "inline") {
...
function lastCheck() {
	if($("#div2").css("display") == "inline"){
		$("#div1").css("display", "inline");
		$("#div2").css("display", "none");
		$("#div3").css("display", "none");
		$("#div4").css("display", "none");
		$("#div5").css("display", "none");
		$("#proProgress").css("width","25%");
		$("#proProgress").html("25%");
		formCheck();
	}
	else if($("#div3").css("display") == "inline"){
...
function executeAction(mode) {
	if (nextCheck()) {
		...
		$.ajax({
             type: "POST",
             url: contextPath+"/benificiary/setUp.action",
             data: params,
             dataType: "json",
             success: function(data){
            	 if(data.resultCode == 1){
            		 window.location = contextPath+"/benificiary/index.action";
